...
BRATS_PATH = '../../../dataset/BraTS_2018/processed/data_3D_train.hdf5'

# Path to preprocssed BraTS validation dataset (hdf5 file)
BRATS_VAL_PATH = '../../../dataset/BraTS_2018/processed/data_3D.hdf5'

#Define a location for checkpoints (with trailing slash)
CHECKPOINT_BASE_PATH = "../../baseline/checkpoint"

#Define a location for predictions (with trailing slash)
PREDICTIONS_BASE_PATH = "../../baseline/prediction"

...
def prepare_data(input_folder, output_file, size, input_channels, target_resolution):
    ...
    pid = 0
    datas = json.load(open(os.path.join(input_folder,'dataset.json'),'r'))
    for data in data:
        print(data)
...
if __name__ == '__main__':
    input_folder = '../../../dataset/BraTS_2018/MICCAI_BraTS_2018_Data_Training'
    preprocessing_folder = '../../../dataset/BraTS_2018/processed'
